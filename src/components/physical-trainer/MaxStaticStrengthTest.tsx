...
import { useMaxStaticStrengthTest } from '../../hooks/usePhysicalTests';
...
interface MaxStaticStrengthTestProps {
  clubId: string;
}

const MaxStaticStrengthTest: React.FC<MaxStaticStrengthTestProps> = ({ clubId }) => {
  // تحديد التقييم بناءً على النتيجة (عكس الاختبار السابق)
  ...
  const { data: firestoreData, saveData } = useMaxStaticStrengthTest(clubId);
  ...
  // حساب أفضل نتيجة من المحاولات الثلاث (أطول وقت هو الأفضل)
  const calculateBestResult = (attempt1: number, attempt2: number, attempt3: number): number => {
    ...
    return Math.max(...attempts); // أكبر رقم هو الأفضل (أطول وقت تحمل)
  };
  ...
  const handleSaveData = async () => {
    ...
    try {
      ...
      console.error('Error saving max static strength test:', err);
    } finally {
      setSaving(false);
    }
  };
  ...
  const printResults = () => {
    ...
    const tableContent = `
      ...
      <head>
        <meta charset="UTF-8">
        <title>اختبار القوة القصوى الثابتة - التثبيت</title>
        <style>
          body {
      ...
      <body>
        <h2>اختبار القوة القصوى الثابتة: اختبار التثبيت</h2>
        <table>
          <thead>
            <tr>
              <th>الإسم واللقب</th>
    ...
    <Card className="shadow-sm">
      <Card.Header className="bg-primary text-white">
        <h4 className="mb-0 text-center" dir="rtl">
          ...
          اختبار القوة القصوى الثابتة: اختبار التثبيت
        </h4>
      </Card.Header>
      <Card.Body className="p-4">
          ...
          <Row>
            <Col md={6}>
              ...
              <ul className="mb-0 mt-2">
                <li>1-4 ثانية: ضعيف</li>
                <li>5-9 ثانية: متوسط</li>
                <li>10-19 ثانية: حسن</li>
                <li>20 ثانية: ممتاز</li>
              </ul>
            </Col>
            <Col md={6}>
              ...
              <ul className="mb-0 mt-2">
                ...
                <li>الوقت الأطول يعني أداء أفضل (قوة تحمل)</li>
                <li>كل محاولة مدتها 20 ثانية كحد أقصى</li>
                <li>اختبار التثبيت يقيس القوة الثابتة</li>
              </ul>
            </Col>
          </Row>
        </Alert>
        ...
        <div className="table-responsive">
          <Table bordered className="static-strength-test-table coach-table" dir="rtl">
            <thead>
        ...
        <style>
          {`
            .static-strength-test-table {
              font-size: 13px;
            }
            
            .static-strength-test-table th {
              background-color: #e3f2fd;
              font-weight: bold;
              text-align: center;
            ...
            .static-strength-test-table input:focus {
              border-color: #007bff;
...
export default MaxStaticStrengthTest;
