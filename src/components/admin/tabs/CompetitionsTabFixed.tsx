    ...
    groupsMap.forEach((list, groupKey) => {
      ...
      if (T >= 4 && maxRound >= 2) {
        ...
        for (let s = 0; s < semiCount; s++) {
          ...
          matches[sIdx].loserNextIndex = bronzeIndex + matchOffset;
                      ...
                      <td style={{ whiteSpace: 'nowrap', minWidth: '160px' }}>
                        <div className="d-flex flex-wrap justify-content-center gap-1">
                          <Button
                            ...
                            disabled={loading}
                            style={{ width: 36, height: 32, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', overflow: 'visible' }}
                          >
